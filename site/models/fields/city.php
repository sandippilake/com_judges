...
class JFormFieldCity extends JFormFieldList
{
	...
	protected function getOptions()
	{
		...
		$state = $app->getUserState('judges.filter.state','');
		if($country) {
			$query->where('c.cb_state LIKE '.$db->quote($state));
		}
